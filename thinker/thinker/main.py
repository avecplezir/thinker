...
class Env(gym.Wrapper):
    def __init__(self,
        ...
        self._logger.info(
            f"Init. environment with obs space \033[91m{self.real_state_space}\033[0m and action space \033[91m{self.pri_action_space}\033[0m")
...
class EnvImagination(Env):
    def __init__(self,
                 model_net=None,
                 flags=None,
                 real_state_space=None,
                 pri_action_space=None,
                 frame_stack_n=None,
                 ):
    ...
    def reset(self, obs, pass_action):
        self.initial_per_state = self.model_net.initial_state(batch_size=obs.shape[0], device=obs.device)
    ...
    def step(self, action):
        ...
        return model_net_out, model_net_out.rs, model_net_out.dones, {}
